...
(function() {
  ...
  var LightboxOptions = (function() {
    ...
    LightboxOptions.prototype.albumLabel = function(curImageNum, albumSize) {
      return "Photo " + curImageNum + " of " + albumSize;
    };
  ...
  var Lightbox = (function() {
    ...
    Lightbox.prototype.build = function() {
      var self = this;
      var shareButtons = "";
      if( $('body').find('#lightbox-share').length > 0 ){
    ...
    Lightbox.prototype.start = function($link) {
      ...
      // var top  = $window.height() / 2 - ( ( this.$lightbox.find('.lb-outerContainer').outerHeight(true) 
                          // + this.$lightbox.find('.lb-dataContainer').outerHeight(true) ) / 2 ) - this.options.positionFromTop;
    ...
    Lightbox.prototype.sizeContainer = function(imageWidth, imageHeight) {
      ...
      var oldWidth  = this.$outerContainer.outerWidth(true);
      var oldHeight = this.$outerContainer.outerHeight(true);
    ...
    Lightbox.prototype.updateNav = function() {
      ...
      var nav_top = ( this.$lightbox.find('.lb-image').height() / 2 );
      this.$lightbox.find('.lb-nav').show().css({ top: nav_top });
